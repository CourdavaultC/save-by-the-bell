 ...
 */
final class Version20200616085942 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE half_journey CHANGE half_date half_date DATE NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE half_journey CHANGE half_date half_date DATETIME NOT NULL');
        $this->addSql('ALTER TABLE presences CHANGE user_id user_id INT DEFAULT NULL');
