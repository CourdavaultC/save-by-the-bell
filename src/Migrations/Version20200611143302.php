 ...
 */
final class Version20200611143302 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE session ADD date_start DATETIME NOT NULL, ADD date_end DATETIME NOT NULL');
        $this->addSql('ALTER TABLE user ADD session_id INT NOT NULL, CHANGE roles roles JSON NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE session DROP date_start, DROP date_end');
