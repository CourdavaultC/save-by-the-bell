 ...
 */
final class Version20200612103231 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE session DROP dates_session');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE presences CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE session ADD dates_session DATETIME NOT NULL');
