 ...
 */
final class Version20200612093242 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE presences ADD user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE presences ADD CONSTRAINT FK_BDDBEFABA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_BDDBEFABA76ED395 ON presences (user_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_BDDBEFABA76ED395 ON presences');
        $this->addSql('ALTER TABLE presences DROP user_id');
